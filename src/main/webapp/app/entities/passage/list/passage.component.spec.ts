...
import { sampleWithRequiredData } from '../passage.test-samples';
...
describe('Passage Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PassageComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.passages?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to passageService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getPassageIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPassageIdentifier).toHaveBeenCalledWith(entity);
